...
class ChangePasswordUseCase @Inject constructor(private val authenticationRepoImpl: AuthenticationRepo) : BaseRemoteUseCase<BaseResponse<ChangePasswordDto>, ChangePasswordDto, String>() {
